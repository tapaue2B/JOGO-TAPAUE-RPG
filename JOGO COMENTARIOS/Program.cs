...
class Program
{
    ...
    static void personagem()
    {
        ...
        switch (resp) // Segue um caminho dependendo do valor da variavel
        {
            ...
            case 2:
                ...
                spe = 130; // Atribui o numero de velocidade á variavel spe
                confirmar(); // inicia a função confirma
                break;
            case 3:
    ...
    static void ano2M()
    {
        if (inimigo3 == "vivo")
        {
            ...
            Console.ReadLine();
            Console.Clear();
            Console.WriteLine(nome + ": VISH quero ficar nessa aula não, vou gazear");
            Console.ReadLine();
        ...
        {
            Console.Clear();
            Console.WriteLine("Savio: não vamo entrar ai de novo não oh...");
            ensinoMedio();
        }
    }
    ...
    static void carlaovitoria()
    {
        ...
        else
        {
            ...
            Console.ReadLine();
            Console.WriteLine("Carlão: Você agora vai ficar fazendo portifólio comigo hahahahahaha");
            Console.ReadLine();
            Console.Clear();
            finalR2();
        }
